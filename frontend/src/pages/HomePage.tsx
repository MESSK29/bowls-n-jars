...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-16">
      ...
      <section className="relative pt-6 sm:pt-12 pb-8 sm:pb-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <AnimatedSection direction="up" className="lg:col-span-7 space-y-6 sm:space-y-8">
              
              {/* Studio Origin Pill */}
              <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-sand-200 border border-sand-300 text-xs font-semibold text-clay-700">
              ...
              <div className="space-y-2">
                <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-clay-900 leading-[1.12]">
                  {t('hero.title_1')}{' '}
              ...
              {/* Subtext */}
              <p className="text-base sm:text-lg text-clay-600 max-w-xl leading-relaxed">
                {t('hero.description')}
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 pt-2">
                <Link
                  to="/shop"
                  onClick={playTap}
                  className="px-8 py-4 bg-terracotta-500 hover:bg-terracotta-600 text-white rounded-2xl font-bold text-sm text-center shadow-warm-md hover:shadow-warm-lg transition-all"
                >
                  {t('hero.cta_shop')}
                </Link>
                <Link
                  to="/about"
                  onClick={playTap}
                  className="px-8 py-4 bg-white/90 hover:bg-white text-clay-800 border border-sand-300 rounded-2xl font-semibold text-sm text-center shadow-warm-xs transition-all"
                >
                  {t('hero.cta_story')}
                </Link>
              </div>
              ...
              {/* Customer Rating Bar */}
              <div className="flex flex-wrap items-center gap-4 pt-4 text-xs font-medium text-clay-600 border-t border-sand-300/80">
                <div className="flex items-center space-x-1 text-ochre-600">
                  ...
                  <span className="text-clay-500 font-normal">Customer Rating</span>
                </div>
            ...
            {/* Right Hero Image Column - Clean & Uncluttered */}
            <AnimatedSection direction="up" delay={0.15} className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md lg:max-w-none">
                <div className="rounded-3xl overflow-hidden shadow-warm-lg border border-sand-300 bg-sand-200 aspect-4/5 relative">
                  <img
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    <span className="px-3 py-1 bg-terracotta-500/90 backdrop-blur-md rounded-lg text-[10px] font-bold uppercase tracking-wider mb-2 inline-block">
                      Jaipur &amp; Khurja Crafts
                    </span>
                    <h3 className="font-heading text-xl sm:text-2xl font-bold">
                      The Earth &amp; Stone Series
                    </h3>
                    <p className="text-xs text-cream-200 mt-1 opacity-90">
      ...
      {/* 2. GROUNDED ARTISANAL TRUST PILLARS (Clean Static Badges) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          
          <div className="bg-white/80 p-5 rounded-2xl border border-sand-300 shadow-warm-xs flex items-center space-x-3.5">
            <div className="w-11 h-11 rounded-xl bg-sage-100 text-sage-700 flex items-center justify-center shrink-0">
          ...
          <div className="bg-white/80 p-5 rounded-2xl border border-sand-300 shadow-warm-xs flex items-center space-x-3.5">
            <div className="w-11 h-11 rounded-xl bg-terracotta-100 text-terracotta-700 flex items-center justify-center shrink-0">
          ...
          <div className="bg-white/80 p-5 rounded-2xl border border-sand-300 shadow-warm-xs flex items-center space-x-3.5">
            <div className="w-11 h-11 rounded-xl bg-sand-200 text-clay-700 flex items-center justify-center shrink-0">
          ...
          <div className="bg-white/80 p-5 rounded-2xl border border-sand-300 shadow-warm-xs flex items-center space-x-3.5">
            <div className="w-11 h-11 rounded-xl bg-ochre-100 text-ochre-700 flex items-center justify-center shrink-0">
      ...
      <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link
            ...
            onClick={playTap}
            className="group relative rounded-3xl overflow-hidden aspect-4/3 sm:aspect-16/10 border border-sand-300 shadow-warm-sm hover:shadow-warm-md transition-all duration-300"
          >
            <img
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-clay-900/80 via-clay-900/30 to-transparent" />
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <span className="text-xs font-semibold tracking-wider uppercase text-terracotta-300 mb-1.5 block">
                Artisanal Pottery
              </span>
              <h3 className="font-heading text-2xl sm:text-3xl font-bold mb-2">
                Ceramics &amp; Kitchenware
              </h3>
              <p className="text-xs sm:text-sm text-cream-200 line-clamp-2 max-w-md opacity-90 mb-4">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-clay-900/80 via-clay-900/30 to-transparent" />
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <span className="text-xs font-semibold tracking-wider uppercase text-sage-300 mb-1.5 block">
                Tactile Workspace
              </span>
              <h3 className="font-heading text-2xl sm:text-3xl font-bold mb-2">
      ...
      <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 pb-4 border-b border-sand-300">
          <div>
          ...
          <Link
            ...
            onClick={playTap}
            className="mt-3 sm:mt-0 text-xs font-semibold text-terracotta-600 hover:text-terracotta-700 flex items-center space-x-1"
          >
      ...
      <AnimatedSection className="bg-sand-100 py-16 sm:py-24 border-y border-sand-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="font-heading text-3xl sm:text-4xl font-bold text-clay-900 leading-tight">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="p-4 bg-white/90 rounded-2xl border border-sand-300">
                  <h4 className="font-heading text-base font-bold text-clay-900">Jaipur &amp; Khurja</h4>
                  <p className="text-xs text-clay-500 mt-1">Direct fair-trade partnership with Indian master potters.</p>
                </div>
                <div className="p-4 bg-white/90 rounded-2xl border border-sand-300">
                  <h4 className="font-heading text-base font-bold text-clay-900">Zero Plastic</h4>
                  <p className="text-xs text-clay-500 mt-1">100% recyclable, biodegradable honeycomb cushioning.</p>
                </div>
              </div>
              ...
              <div className="pt-2">
                <Link
                  to="/about"
                  onClick={playTap}
                  className="inline-flex items-center space-x-2 text-sm font-bold text-terracotta-600 hover:text-terracotta-700"
                >
      ...
      {/* 6. NEW STUDIO ADDITIONS */}
      <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 pb-4 border-b border-sand-300">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-sage-600 block mb-1">
              Curator&apos;s Selection
            </span>
            <h2 className="font-heading text-3xl font-bold text-clay-900">
